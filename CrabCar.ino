...
if (ctl->a()){
 ...
 int maxInput = 512;  // Maksymalne wychylenie
 int minAngle = 0;   // Minimalny kąt skrętu
 int centerAngleA1 = 68; // Środkowa pozycja A1
 int centerAngleB1 = 128;// Środkowa pozycja B1
 int centerAngleB2 = 137;// Środkowa pozycja B2
 int centerAngleA2 = 0;// Środkowa pozycja A2
 int maxAngle = 180;  // Maksymalny kąt skrętu
...
if (abs(skret) > 100) {
    ...
    int angleOffsetA1 = (int)(normalized * 40);  
    int angleOffsetB1 = (int)(normalized * 40);
   ...
   /* Serial.print("Skret: ");
    ...
    int mapGaz = map(gaz, 0, 1023, 0, 200);
    ...
    int mapWST = map(wsteczny, 0, 1023, 0, 200);
    ...
    if (ctl->x()) { //TRYB KRABA WŁĄCZONY
        ...
        myservoA1.write(myservoA1.read());
        delay(35);
        myservoB1.write(myservoB1.read());        
        delay(35);
        myservoA2.write(myservoA2.read());
        delay(35);
        myservoB2.write(myservoB2.read());
        delay(500);
        Serial.println("KRABMODE: PROCESSING");
        myservoA1.write(160);
        delay(35);
